  ...
  <div class="row">
    <div id="content" class="col-sm-12">
      ...
      <div class="row ac_menu">
        ...
        <div class="col-sm-4">
          <div class="col-sm-12">
            <a href="index.php?route=account/address/edit&address_id=<?php echo $address_id; ?>">
              <img width="120" src="image/icons/Icon1.png" /><br />
              Account
              Details
              <p class="ac_description">Review your personal information.</p></a> <br />
          </div>
        </div>


        <div class="col-sm-4">
          <div class="col-sm-12"><a href="<?php echo $wishlist; ?>">
        ...
        <div class="col-sm-4">
          <div class="col-sm-12">
            <a href="<?php echo $order; ?>"><img width="120" src="image/icons/Icon2.png" /><br />
              Order History
              <p class="ac_description">Check the history and current status of your orders.</p></a>
