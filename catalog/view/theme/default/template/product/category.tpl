    ...
    <div id="content" class="col-sm-12 product-wrapper">
      ...
      <?php if ($categories) { ?>
        ...
        <?php if (count($categories) <= 5) { ?>
          <div class="row">
            <div style="margin: auto;" class=" sub-cate-list">
              <ul>
      ...
      <?php if ($products) { ?>
        ...
        <div class="row" style="width: 100%; display:inline-block">
          ...
          <div style="max-width: 200px; float:right; margin-top:-35px; padding-top:5px" class="form-group input-group input-group-sm">
        ...
        <div id="product_box" class="row">
          ...
          foreach ($products as $product) { ?>
            <?php if ($k < 6) { ?>
              <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-6 text-center">
                <div class="product-thumb">
                  ...
                  <div>
                    ...
                    <div class="caption">
                      <p class="product_name"><?php echo strtolower($product['name']); ?></p>
