    ...
    <div id="content" class="col-sm-12">
      <div class="row">
          ...
          <?php if ($thumb || $images) { ?>
            <div id="s_wrap">
              <ul style="background: none;" class="slider slider-for">
                <?php if ($thumb) { ?>
                  <li data-toggle="modal" data-target="#exampleModal" class="zoom">
                ...
                <?php if ($images) { ?>
                  <?php foreach ($images as $image) { ?>
                    <li data-toggle="modal" data-target="#exampleModal" class="zoom"><img class="img-responsive" style="margin: auto; margin-right:-5px;" src="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></li>
                  <?php } ?>
                <?php } ?>
              </ul>
            </div>
          ...
          <div class="product-large-slider">
            <?php if ($thumb) { ?>
              <div class="pro-large-img">
                <img data-toggle="modal" data-target="#exampleModal" src="<?php echo $thumb; ?>" alt="product-details" />
              </div>
            <?php } ?>
            <?php if ($images) { ?>
              <?php foreach ($images as $image) { ?>
                <div class="pro-large-img">
                  <img data-toggle="modal" data-target="#exampleModal" src="<?php echo $image['popup']; ?>" alt="product-details" />
                </div>
              <?php } ?>
            <?php } ?>
          </div>
        ...
        <div class="col-lg-4 pinfo">
          ...
          <div style="padding-top: 0px; margin-top:5px;" class="price-box">
            <?php if ($price) { ?>
          ...
          <div id="product">
            <?php if ($options) { ?>
              ...
              <?php foreach ($options as $option) { ?>
                <?php if ($option['type'] == 'select') { ?>
                  <div style="padding:0px; margin-top:15px;" class="col-xs-12 select-box">
                  ...
                  <div style="padding:0px; padding-left:10px;" class="col-xs-12">
                    <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                      ...
                      <select style="display:none" name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control me_select">
                ...
                <a href="#" style="color:#444" data-toggle="modal" data-target="#sizeModal"><u>Size Guide</u> </a>
                <br />
              <?php } ?>
            ...
            <div style="display: inline-block; width:100%; margin-bottom:0px; margin-top:30px;" class="form-group">
            ...
            <div style="padding: 0px;" class="col-sm-12 col-12">
              <?php if ($location) { ?>
                <hr />
                <p class="sub-heading"><b>Color:</b> <?php echo $location; ?></p>
                <p class="sub-heading"><b>Fabric:</b> <?php echo $isbn; ?></p>
                <hr />
              <?php } ?>
              <p><?php echo strip_tags($description, "<br /><br>"); ?></p>
      ...
      <div style="margin: 0px; display:none" class="row">
        <div class="col-sm-12">
...
<div class="modal fade" id="sizeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body text-center" style='background-color:#FEE8D0'>
        <div class="row">
          <div class="col-sm-12">
            <img class="img-responsive " style="margin: auto; display:block" src="image/catalog/sizechart.png" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
          </div>
        </div>
        <br />
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
  ...
  $(".tab_options").click(function() {
    ...
    $(".tab_options").css("border", "thin solid #ccc");
    $(this).css("border", "thin solid #333");

    /* var img = $(this).attr("data-image");
     var image = document.createElement('img'); // new Image(1, 1);
     image.src = img;
     image.className = "img-responsive";
     $(".slick-current img").replaceWith(image);


     // var money = $(this).attr("data-money");*/
    var val = $(this).attr("data-val");

    $(".me_select option").prop("selected", false);
    $(".me_select option").each(function(index, element) {
      if ($(this).val() == val) {
      ...
      success: function(json) {
        ...
        if (json['success']) {
          ...
          setTimeout(function() {
            ...
            $('#cart_count').html(json['total'].substring(0, 1));
          }, 100);
